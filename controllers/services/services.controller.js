...
exports.GetAll = async (req, res, next) => {
    ...
    let { DB_error, DB_value } = await ServiceService.GetAll(pageNo, pageSize, search);
...
exports.GetEachAndEvery = async (req, res, next) => {
    ...
    let { DB_error, DB_value } = await ServiceService.GetEachAndEvery( search );
...
exports.GetAllActive = async (req, res, next) => {
    ...
    let { DB_error, DB_value } = await ServiceService.GetAllActive( search );
