...
const { GetAll, Get, Create, Update, Delete, updatePassword} = require('../controllers/user/user.controller');
...
.post(AuthenticatePermission(Resources['Users'], Actions['Update']), HandleNullString, updatePassword)
// // GET ALL USERS
// router.get('/', (req, res)=>{
